...
yest_cds <- readRDS("/home/degan/ip_proteomics/figures/UMAP/yeast_del_strain_monocle3_cds.RDS")
...
cluster_1 <- cluster_assignment[cluster_assignment$cluster == 20, , drop=F]
...
ggplot(avg_cluster_pd1, aes(x=Var2, y=value)) + 
  geom_boxplot() +  stat_compare_means() + theme_classic()
